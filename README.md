...
·Herramientas: Tenemos varias herramientas que sirven para mover objetos, rotarlos, cambiar sus tamaños en diferentes ejes, cambiar el pivot de un objeto, ejecutar el juego, pararlo sin detenerlo para poder avanzar frame a frame, etc. También podemos crear herramientos propias.
